...
const handleFormSubmit = function() {
	$('#search-term-input').submit(function(event) {
		event.preventDefault();
		fetchVideos($('#search-term').val(), function(response) {
			$('#search-term').val('');
			const videosToAdd = decorateResponse(response);
			addVideosToStore(videosToAdd);
			render();
		});
	});
};
